          ...
          {folders.map((folder) => (
            <div key={folder.id} className="group relative">
              ...
              <button
                ...
                className="absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity bg-destructive/90 text-white rounded-full p-1.5 hover:bg-destructive z-10"
              >
                {deleting === folder.id ? (
